...
const ErrorFallback = ({ resetErrorBoundary }: FallbackProps) => {
	...
	return (
		<div role="alert" className="flex h-screen w-full flex-col items-center justify-center gap-8 p-8 md:flex-row">
			<img src="/assets/images/feedbacks/server-error.svg" alt="server error" className="w-160" />
			...
			<div className="mx-64 flex flex-col justify-end md:mx-0">
				...
				<div className="mt-24 flex justify-end gap-12">
					<Button onClick={resetErrorBoundary} variant="primary" icon="repeat">
						Tentar novamente
					</Button>
					<Button onClick={contactSupport} variant="secondary" icon="message-square-text">
						Suporte
					</Button>
				</div>
			</div>
