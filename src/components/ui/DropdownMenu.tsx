...
>(({ className, sideOffset = 4, ...props }, ref) => (
	<DropdownMenuPrimitive.Portal>
		<DropdownMenuPrimitive.Content
			...
			className={cn(
				'z-50 min-w-[8rem] space-y-8 overflow-hidden rounded-md border border-neutral-800 bg-neutral-950 p-10 text-neutral-50 shadow-md',
...
>(({ className, ...props }, ref) => (
	<DropdownMenuPrimitive.Label
		ref={ref}
		className={cn('p-2 text-md font-semibold', className)}
		{...props}
	/>
));
